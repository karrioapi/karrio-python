...
class RateRequest(object):
    ...
    def services(self):
        """Gets the services of this RateRequest.  # noqa: E501
         ...
         The requested carrier service for the shipment.<br/> Please consult the API reference for specific carriers services.  Note that this is a list because on a Multi-carrier rate request you could specify a service per carrier.   # noqa: E501
    ...
    def options(self):
        """Gets the options of this RateRequest.  # noqa: E501
         ...
         The options available for the shipment.  Please consult the API reference for additional specific carriers options.   # noqa: E501
