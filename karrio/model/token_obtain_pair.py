...
class TokenObtainPair(ModelNormal):
    ...
    def _from_openapi_data(cls, email, password, *args, **kwargs):  # noqa: E501
        """TokenObtainPair - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            org_id (str):  **should be specified only in a multi-org deployment.**  Note the first org related to the user is selected by default. . [optional]  # noqa: E501
        """
