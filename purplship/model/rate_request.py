...
class RateRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, shipper, recipient, parcels, *args, **kwargs):  # noqa: E501
        """RateRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            services ([str], none_type):  The requested carrier service for the shipment.<br/> Please consult [the reference](#operation/references) for specific carriers services.  Note that this is a list because on a Multi-carrier rate request you could specify a service per carrier. . [optional]  # noqa: E501
            options ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type):  The options available for the shipment.  Please consult [the reference](#operation/references) for additional specific carriers options. . [optional]  # noqa: E501
            reference (str, none_type): The shipment reference. [optional]  # noqa: E501
            carrier_ids ([str], none_type):  The list of configured carriers you wish to get rates from. . [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, shipper, recipient, parcels, *args, **kwargs):  # noqa: E501
        """RateRequest - a model defined in OpenAPI
