...
class CarrierSettings(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, carrier_name, carrier_id, test, active, *args, **kwargs):  # noqa: E501
        """CarrierSettings - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            object_type (str): Specifies the object type. [optional] if omitted the server will use the default value of "carrier"  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, carrier_name, carrier_id, test, active, *args, **kwargs):  # noqa: E501
        """CarrierSettings - a model defined in OpenAPI
