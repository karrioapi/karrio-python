...
class ShipmentData(object):
    ...
    def services(self):
        """Gets the services of this ShipmentData.  # noqa: E501
         ...
         The requested carrier service for the shipment.  Please consult the API reference for specific carriers services.<br/> Note that this is a list because on a Multi-carrier rate request you could specify a service per carrier.   # noqa: E501
