...
class Rate(object):
    ...
    def fetch(self, data, **kwargs):  # noqa: E501
        """Fetch Shipment Rates  # noqa: E501

         The Shipping process begins by fetching rates for your shipment. The request returns rates required to create your shipment.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.fetch(data, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param RateRequest data: (required)
        :return: RateResponse
        ...
        if kwargs.get('async_req'):
            return self.fetch_with_http_info(data, **kwargs)  # noqa: E501
        else:
            (data) = self.fetch_with_http_info(data, **kwargs)  # noqa: E501
            return data

    def fetch_with_http_info(self, data, **kwargs):  # noqa: E501
        """Fetch Shipment Rates  # noqa: E501

         The Shipping process begins by fetching rates for your shipment. The request returns rates required to create your shipment.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.fetch_with_http_info(data, async_req=True)
        >>> result = thread.get()
        ...
        if ('data' not in params or
                params['data'] is None):
            raise ValueError("Missing the required parameter `data` when calling `fetch`")  # noqa: E501
