...
class TrackingStatus(object):
    ...
    def __init__(self, id=None, carrier_name=None, carrier_id=None, tracking_number=None, events=None, delivered=None, test_mode=None):  # noqa: E501
        """TrackingStatus - a model defined in Purplship"""  # noqa: E501
        self._id = None
