...
class Metadata(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, app_name, app_version, app_website, multi_organizations, admin, openapi, graphql, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, app_name, app_version, app_website, multi_organizations, admin, openapi, graphql, *args, **kwargs):  # noqa: E501
        """Metadata - a model defined in OpenAPI
