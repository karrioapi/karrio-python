...
class TokenPair(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, access, refresh, *args, **kwargs):  # noqa: E501
        """TokenPair - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, access, refresh, *args, **kwargs):  # noqa: E501
        """TokenPair - a model defined in OpenAPI
