...
class ShippingRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, shipper, recipient, parcels, selected_rate_id, rates, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, shipper, recipient, parcels, selected_rate_id, rates, *args, **kwargs):  # noqa: E501
        """ShippingRequest - a model defined in OpenAPI
