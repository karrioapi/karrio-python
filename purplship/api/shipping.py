...
class ShippingApi(object):
    ...
    def buy_label(self, data, **kwargs):  # noqa: E501
        """Submit a Shipment  # noqa: E501
        ...
        :param ShippingRequest data: (required)
        ...
        if kwargs.get('async_req'):
            return self.buy_label_with_http_info(data, **kwargs)  # noqa: E501
        else:
            (data) = self.buy_label_with_http_info(data, **kwargs)  # noqa: E501
            return data

    def buy_label_with_http_info(self, data, **kwargs):  # noqa: E501
        """Submit a Shipment  # noqa: E501

         **[proxy]**  Once the shipping rates are retrieved, provide the required info to submit the shipment by specifying your preferred rate.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.buy_label_with_http_info(data, async_req=True)
        >>> result = thread.get()
        ...
        if ('data' not in params or
                params['data'] is None):
            raise ValueError("Missing the required parameter `data` when calling `buy_label`")  # noqa: E501
