...
class ShipmentData(ModelNormal):
    ...
    def _from_openapi_data(cls, shipper, recipient, parcels, *args, **kwargs):  # noqa: E501
        """ShipmentData - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            service (str): **Specify a service to Buy a label in one call without rating.**. [optional]  # noqa: E501
            services ([str], none_type):  The requested carrier service for the shipment.  Please consult the reference for specific carriers services.<br/> Note that this is a list because on a Multi-carrier rate request you could specify a service per carrier. . [optional]  # noqa: E501
