...
class RateResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, rates, *args, **kwargs):  # noqa: E501
        """RateResponse - a model defined in OpenAPI

        Args:
            rates ([Rate]): The list of returned rates
    ...
    @convert_js_args_to_python_args
    def __init__(self, rates, *args, **kwargs):  # noqa: E501
        """RateResponse - a model defined in OpenAPI
