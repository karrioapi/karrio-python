...
class Shipment(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'label_url': (str, none_type,),  # noqa: E501
            'invoice_url': (str, none_type,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, shipper, recipient, parcels, created_at, test_mode, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            object_type (str): Specifies the object type. [optional] if omitted the server will use the default value of "shipment"  # noqa: E501
            tracking_url (str, none_type): The shipment tracking url. [optional]  # noqa: E501
            services ([str], none_type):  The carriers services requested for the shipment.  Please consult the reference for specific carriers services.<br/> Note that this is a list because on a Multi-carrier rate request you could specify a service per carrier. . [optional]  # noqa: E501
            ...
            metadata ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): User metadata for the shipment. [optional]  # noqa: E501
            messages ([Message]): The list of note or warning messages. [optional]  # noqa: E501
            status (str): The current Shipment status. [optional] if omitted the server will use the default value of "draft"  # noqa: E501
            ...
            label_url (str, none_type): The shipment label URL. [optional]  # noqa: E501
            invoice_url (str, none_type): The shipment invoice URL. [optional]  # noqa: E501
        """
