...
class RateRequest(object):
    ...
    def __init__(self, shipper=None, recipient=None, parcel=None, services=None, options=None, reference=None, carrier_ids=None):  # noqa: E501
        """RateRequest - a model defined in PurplShip"""  # noqa: E501
    ...
    @property
    def parcel(self):
        """Gets the parcel of this RateRequest.  # noqa: E501


        :return: The parcel of this RateRequest.  # noqa: E501
        :rtype: Parcel
        """
        return self._parcel
    ...
    def parcel(self, parcel):
        """Sets the parcel of this RateRequest.


        :param parcel: The parcel of this RateRequest.  # noqa: E501
        :type: Parcel
        """
        if parcel is None:
    ...
    def services(self):
        """Gets the services of this RateRequest.  # noqa: E501
         ...
         The requested carrier service for the shipment.<br/> Please consult the reference for specific carriers services.  Note that this is a list because on a Multi-carrier rate request you could specify a service per carrier.   # noqa: E501
    ...
    def options(self):
        """Gets the options of this RateRequest.  # noqa: E501
         ...
         The options available for the shipment.  Please consult the reference for additional specific carriers options.   # noqa: E501
