...
class Shipment(object):
    ...
    def status(self, status):
        ...
        :type: str
        """
        allowed_values = ["created", "purchased", "shipped", "transit", "delivered"]  # noqa: E501
