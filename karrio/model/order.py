...
class Order(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'shipping_to': (Address,),  # noqa: E501
            'line_items': ([Commodity],),  # noqa: E501
    ...
    attribute_map = {
        ...
        'shipping_to': 'shipping_to',  # noqa: E501
        ...
        'shipping_from': 'shipping_from',  # noqa: E501
        'options': 'options',  # noqa: E501
        'metadata': 'metadata',  # noqa: E501
        'shipments': 'shipments',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, order_id, shipping_to, line_items, test_mode, created_at, *args, **kwargs):  # noqa: E501
        """Order - a model defined in OpenAPI

        Args:
            order_id (str): The source' order id.
            shipping_to (Address):
            line_items ([Commodity]): The order line items.
        ...
        Keyword Args:
            ...
            object_type (str): Specifies the object type. [optional] if omitted the server will use the default value of "order"  # noqa: E501
            source (str): The order's source.. [optional]  # noqa: E501
            status (str): The order status.. [optional] if omitted the server will use the default value of "unfulfilled"  # noqa: E501
            shipping_from (Address): [optional]  # noqa: E501
            options ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type):  <details> <summary>The options available for the order shipments.</summary>  ``` {     \"currency\": \"USD\", } ```  Please check the docs for shipment specific options. </details> . [optional]  # noqa: E501
            metadata ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): User metadata for the order.. [optional]  # noqa: E501
            shipments ([Shipment]): The shipments associated with the order.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, order_id, shipping_to, line_items, test_mode, created_at, *args, **kwargs):  # noqa: E501
        """Order - a model defined in OpenAPI
