...
class PaymentData(object):
    ...
    def __init__(self, paid_by='sender', amount=None, currency=None, account_number=None, contact=None):  # noqa: E501
        """PaymentData - a model defined in Purplship"""  # noqa: E501
        self._paid_by = None
        self._amount = None
        self._currency = None
