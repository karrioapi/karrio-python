...
class Webhook(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'last_event_at': (datetime, none_type,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, url, enabled_events, test_mode, secret, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            description (str, none_type): An optional description of what the webhook is used for.. [optional]  # noqa: E501
            disabled (bool, none_type): Indicates that the webhook is disabled. [optional]  # noqa: E501
            object_type (str): Specifies the object type. [optional] if omitted the server will use the default value of "webhook"  # noqa: E501
            last_event_at (datetime, none_type): The datetime of the last event sent.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, url, enabled_events, test_mode, secret, *args, **kwargs):  # noqa: E501
        """Webhook - a model defined in OpenAPI
