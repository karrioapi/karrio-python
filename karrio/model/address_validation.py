...
class AddressValidation(ModelNormal):
    ...
    def _from_openapi_data(cls, success, *args, **kwargs):  # noqa: E501
        """AddressValidation - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            meta ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type): validation service details. [optional]  # noqa: E501
        """
