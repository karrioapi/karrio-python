...
class References(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, app_name, app_version, countries, currencies, carriers, customs_content_type, incoterms, states, services, service_names, options, option_names, package_presets, packaging_types, payment_types, carrier_capabilities, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, app_name, app_version, countries, currencies, carriers, customs_content_type, incoterms, states, services, service_names, options, option_names, package_presets, packaging_types, payment_types, carrier_capabilities, *args, **kwargs):  # noqa: E501
        """References - a model defined in OpenAPI
