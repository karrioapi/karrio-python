...
class PickupCancelRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, confirmation_number, *args, **kwargs):  # noqa: E501
        """PickupCancelRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            pickup_date (str, none_type):  The pickup date  Date Format: `YYYY-MM-DD` . [optional]  # noqa: E501
            reason (str): The reason of the pickup cancellation. [optional]  # noqa: E501
        """
