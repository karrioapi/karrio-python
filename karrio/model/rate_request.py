...
class RateRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, shipper, recipient, parcels, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            services ([str], none_type):  The requested carrier service for the shipment.<br/> Please consult the reference for specific carriers services.  Note that this is a list because on a Multi-carrier rate request you could specify a service per carrier. . [optional]  # noqa: E501
