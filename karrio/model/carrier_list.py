...
def lazy_import():
    ...
    globals()['CarrierSettings'] = CarrierSettings


class CarrierList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'results': ([CarrierSettings],),  # noqa: E501
    ...
    def _from_openapi_data(cls, results, *args, **kwargs):  # noqa: E501
        """CarrierList - a model defined in OpenAPI

        Args:
            results ([CarrierSettings]):
