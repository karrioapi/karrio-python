...
class CustomsData(object):
    ...
    def __init__(self, aes=None, eel_pfc=None, content_type=None, content_description=None, incoterm=None, commodities=None, duty=None, invoice=None, commercial_invoice=None, certify=None, signer=None, certificate_number=None, options=None):  # noqa: E501
        """CustomsData - a model defined in Purplship"""  # noqa: E501
        self._aes = None
        self._eel_pfc = None
