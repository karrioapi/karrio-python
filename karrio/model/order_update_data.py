...
class OrderUpdateData(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """OrderUpdateData - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            options ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type): The order options. [optional]  # noqa: E501
