...
class TokenRefresh(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, refresh, *args, **kwargs):  # noqa: E501
        """TokenRefresh - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            access (str): [optional]  # noqa: E501
            org_id (str):  **should be specified only in a multi-org deployment.** . [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, refresh, *args, **kwargs):  # noqa: E501
        """TokenRefresh - a model defined in OpenAPI
