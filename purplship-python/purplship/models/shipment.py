...
class Shipment(object):
    ...
    def __init__(self, selected_rate_id=None, rates=None, shipper=None, recipient=None, parcel=None, services=None, options=None, payment=None, customs=None, doc_images=None, reference=None, tracking_url=None, id=None, carrier_name=None, carrier_id=None, label=None, tracking_number=None, selected_rate=None):  # noqa: E501
