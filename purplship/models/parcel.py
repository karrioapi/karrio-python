...
class Parcel(object):
    ...
    def packaging_type(self):
        """Gets the packaging_type of this Parcel.  # noqa: E501
         ...
         The parcel's packaging type.  Note that the packaging is optional when using a package preset  For specific carriers packaging type, please consult [the reference](./UtilsApi.md#references).   # noqa: E501
    ...
    def package_preset(self):
        """Gets the package_preset of this Parcel.  # noqa: E501
         ...
         The parcel's package preset.  For specific carriers package preset, please consult [the reference](./UtilsApi.md#references).   # noqa: E501
